  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem" }}>
      <div style={{ textAlign: "center", marginBottom: "4rem" }}>
        <h1 style={{ fontSize: "3rem", marginBottom: "1rem" }}>Package Manager for Claude Skills</h1>
        <p style={{ fontSize: "1.25rem", color: "var(--text-secondary)", marginBottom: "2rem" }}>
          Discover, share, and manage Claude Skills with dependencies, versioning, and a beautiful registry.
        </p>
        <form
          onSubmit={handleSearch}
          style={{ display: "flex", gap: "1rem", justifyContent: "center", maxWidth: "600px", margin: "0 auto" }}
        >
          <input
            type="search"
            value={search}
