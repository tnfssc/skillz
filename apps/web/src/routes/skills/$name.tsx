    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "2rem" }}>
          ...
          >
            ...
            <div style={{ fontSize: "0.9rem", color: "var(--text-secondary)" }}>
              <a
                ...
                style={{ color: "var(--primary)", textDecoration: "none", display: "block", marginBottom: "0.5rem" }}
              >
                GitHub Repository ↗
              </a>
              <a
                href={skill.homepage || "#"}
                style={{ color: "var(--primary)", textDecoration: "none", display: "block" }}
              >
                Homepage ↗
              </a>
            </div>
      ...
      <div style={{ minHeight: "400px" }}>
            ...
            {skill.versions.map((v) => (
              ...
              >
                <div>
                  ...
                  <span style={{ color: "var(--text-secondary)" }}>{new Date(v.createdAt).toLocaleDateString()}</span>
                </div>
        ...
        {activeTab === "dependencies" && (
          <div style={{ color: "var(--text-secondary)", fontStyle: "italic" }}>No dependencies listed.</div>
        )}
      </div>
    </div>
  );
