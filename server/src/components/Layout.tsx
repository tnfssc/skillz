        ...
        <div class="container mx-auto px-4 h-16 flex items-center justify-between">
          <div class="flex items-center gap-8">
            ...
            <nav class="hidden md:flex items-center gap-6 text-sm font-medium">
              <a href="/skills" class="text-slate-400 hover:text-white transition-colors">Explore</a>
          ...
          <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul class="space-y-2 text-sm text-slate-500">
                ...
                <li><a href="/skills" class="hover:text-white transition-colors">Registry</a></li>
                <li><a href="/docs#cli" class="hover:text-white transition-colors">CLI Reference</a></li>
              </ul>
            </div>
            <div>
              <h4 class="font-semibold text-slate-300 mb-4">Community</h4>
              <ul class="space-y-2 text-sm text-slate-500">
                <li><a href="https://github.com/tnfssc/skillz" target="_blank" class="hover:text-white transition-colors">GitHub</a></li>
