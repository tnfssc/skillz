    ...
    <Layout user={user}>
      <div class="container mx-auto px-4 py-8">
        <div class="mb-8">
          ...
          <p class="text-slate-400 text-lg">{skill.description || "No description provided."}</p>
              ...
              <div class="space-y-2">
                {versions.slice(0, 10).map((version) => (
                  <div class="flex items-center justify-between py-2 border-b border-slate-700/50 last:border-0">
                    ...
                    <span class="text-xs text-slate-500">{new Date(version.createdAt).toLocaleDateString()}</span>
                  </div>
                ))}
              </div>
            </Card>
